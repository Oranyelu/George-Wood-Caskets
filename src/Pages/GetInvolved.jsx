  ...
  return (
    <div>
      ...
      <main className="max-w-6xl mx-auto py-12 mt-[70px]">
        ...
        <h2 className="text-2xl font-bold mt-6 mb-4">Ways to Get Involved</h2>

        <h3 className="text-xl font-semibold mt-4 mb-2">1. Volunteer with Us</h3>
        <p>
        ...
        <h3 className="text-xl font-semibold mt-4 mb-2">2. Join Our Events</h3>
        <p>
        ...
        <h3 className="text-xl font-semibold mt-4 mb-2">3. Spread the Word</h3>
        <p>
        ...
        <h3 className="text-xl font-semibold mt-4 mb-2">4. Donations</h3>
        <p>
