...
function HeroPage() {
  return (
    ...
    >
      ...
      {/* Centered Content */}
      <div className="relative z-20 flex items-center justify-center  px-4 animate-fadeInScale transform hover:scale-105 transition-transform duration-300 ease-in-out h-[80%]">
      ...
      <div className="h-[20%] fade-div2" ></div>
    </div>
  );
}
