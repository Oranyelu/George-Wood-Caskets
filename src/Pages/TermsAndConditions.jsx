            ...
            <div className="max-w-[1300px] mx-auto px-4 md:px-8">
                ...
                <div className="space-y-6">
                    ...
                    <section className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 transition-colors">
                        ...
                        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                            In order to resolve a complaint regarding the Site or to receive further information regarding use of the Site, please contact us through any of the following channels:
                        </p>
