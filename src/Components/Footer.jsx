      ...
      <footer className="flex justify-evenly pt-5 flex-wrap p-4 bg-gray-100 text-gray-700 w-[100%]">
        <div className="flex flex-wrap justify-around text-left w-[30%]">
          <nav className="flex flex-col mb-4">
            ...
            <Link to="/customers" className="hover:text-[#A37E2C]">
              Customers
            </Link>
            <Link to="/careers" className="hover:text-[#A37E2C]">
              We are hiring
            </Link>
          </nav>
          <nav className="flex flex-col mb-4">
        ...
        <div className="flex flex-wrap text-left justify-around w-[30%]">
          ...
          <nav className="flex flex-col mb-4">
            ...
            <Link to="/contact" className="hover:text-[#A37E2C]">
              Contact Us
            </Link>
            <Link to="/safety" className="hover:text-[#A37E2C]">
              Safety Center
            </Link>
            <Link to="/report-issue" className="hover:text-[#A37E2C]">
              Report an Issue
            </Link>
          </nav>
          <nav className="flex flex-col mb-4">
            <h3 className="font-bold text-lg mb-2 text-[#135B3A]">Features</h3>
            <Link to="/team" className="hover:text-[#A37E2C]">
              Meet our Team
            </Link>
            <Link to="/track-order" className="hover:text-[#A37E2C]">
              Track Order
            </Link>
            <Link to="/articles" className="hover:text-[#A37E2C]">
              Articles
            </Link>
