...
import GeorgeChiemerieChime from "../assets/StaffPicture/WhatsApp Image 2025-04-06 at 19.13.00_ef7a7220.jpg";
...
const StaffCard = ({ name, title, image, bio }) => {
  ...
  const preview = bio.slice(0, 300);

  return (
    <div className="flex flex-col md:flex-row items-start gap-6 border p-6 rounded-2xl shadow-md">
      <img
        src={image}
        alt={name}
  ...
  return (
    <div>
      ...
      <main className="max-w-6xl mx-auto py-12 mt-[70px] px-4">
        ...
        <h2 className="text-2xl font-bold mt-6 mb-6 text-center">Meet Our Team</h2>
